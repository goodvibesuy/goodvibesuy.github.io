...
var PosComponent = /** @class */ (function () {
    ...
    PosComponent.prototype.add = function () {
        var _this = this;
        this.pointOFSaleService.addPointOfSale(this.POSName, this.POSAddress, this.POSTel, this.POSMarker.getPosition()).subscribe(function (response) {
...
var RouteEdit = /** @class */ (function () {
    ...
    RouteEdit.prototype.ngOnInit = function () {
        ...
        this.paramsSub = this.activatedRoute.params
            ...
            _this.routeService.get()
                .subscribe(function (data) {
                _this.route = (data.find(function (s) { return s.idroute == params['id']; }));
    ...
    RouteEdit.prototype.createForm = function () {
        this.myform = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormGroup */]({
            name: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormGroup */]({
    ...
    RouteEdit.prototype.createFormEdit = function () {
        this.editForm = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormGroup */]({
...
var PointOfSaleService = /** @class */ (function () {
    ...
    PointOfSaleService.prototype.addPointOfSale = function (name, address, tel, coords) {
        return this.http.post(this.pointOfSaleURL, { name: name, address: address, tel: tel, coords: coords });
    };
    PointOfSaleService.prototype.updatePointOfSale = function (idPointOfSale, name, address, tel, coord) {
        return this.http.put(this.pointOfSaleURL, { id: idPointOfSale, name: name, address: address, tel: tel, coord: coord });
    };
